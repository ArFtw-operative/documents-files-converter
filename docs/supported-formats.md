...
- PDF Studio: organize, duplicate, and crop pages; inspect text; edit existing paragraphs inline with detected-font preservation and reflow; add reactive text, installed-font content, images, shapes, drawings, and visual signatures; create/update/delete links and fields; edit metadata; apply watermarks and headers/footers; annotate; run installed-language OCR; and permanently redact. Exports are new validated PDFs and never overwrite the source.
